        ...
        if ("entities" in json_resp):
            for place in json_resp["entities"]:
                if (place not in self.db):
                    ...
                    try:
                        lat = json_resp["entities"][place]["claims"]["P625"][0]["mainsnak"]["datavalue"]["value"]["latitude"]
                        lon = json_resp["entities"][place]["claims"]["P625"][0]["mainsnak"]["datavalue"]["value"]["longitude"]
                        try:
                            name = json_resp["entities"][place]["labels"]["en"]["value"]
                        except:
                            try:
                                name = json_resp["entities"][place]["claims"]["P373"][0]["mainsnak"]["datavalue"]["value"]
                            except:
                                name = ""
